...
def main_tracker(video_path):

    dist = 0
    prev_dist = 0
    focal = 885  # Actualizado para la cámara (iPhone 11)
    pix = 30
    width = 6.1  #Ancho del objeto usado como pelota
...
if __name__ == "__main__":
    videopath_detection = "src/4_gf_def.mp4"
    videopath_tracker = "src/tracker_def.mp4"
    
    main_pattern_detection(videopath_detection)
    main_tracker(videopath_tracker)